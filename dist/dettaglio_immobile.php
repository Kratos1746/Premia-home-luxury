...
<nav id="nav-1024-imm" class="max-lg:hidden z-50 pt-4   w-full fixed ">
...
<div class="flex flex-col w-full items-center bg-neutral-900 h-screen min-h-[700px] text-white">
    <div class="w-[90%] h-[70%] overflow-hidden p-2 mt-10 rounded-t-xl border-b-0 border border-white ">
        ...
        <div class="border-b border-white w-[90%] font-Merriweather text-sm min-[450px]:text-base    mb-10  mt-24 flex   gap-10 xl:text-2xl">
    ...
    error: function () {
        ...
        ?>
            ...
            <?php echo '<div class="mb-4">
                ...
                <textarea id="mex" name="messaggio" rows="4" class="w-full p-2 border rounded-md bg-neutral-800 text-white shadow-md shadow-neutral-900 focus:border-orange-300 focus:outline-none" required>Spett.le PREMIA HOME S.R.L., Vi chiedo ulteriori informazioni sul Vostro annuncio Rif.' . $id_immobile . '</textarea>
            </div>'; ?>
