...
if (isset($_GET['messaggio'])) {
 ...
 }  if (isset($_GET['messaggio2 '])) {
     $messaggio2 = urldecode($_GET['messaggio2']);
    echo '<div id="messaggio" style="color: red;" class=" bg-neutral-900 text-lg text-center">' . $messaggio2 . '</div>';
 }
?>
